...
var Topology = {
    ...
    saveKnowledgeMap: function (id) {
        var self = this;
        localStorage.setItem("stor",JSON.stringify(canvas.data)); 
    ...
    onChangeProp: function () {
        ...
        if (selected.type == "line") {
            ...
            if(selected.data.text && selected.data.text !=undefined && selected.data.text.includes("|")){
              selected.data.strokeStyle = "#000000"
            }else {
...
window.onClickShow = Topology.onClickShow
