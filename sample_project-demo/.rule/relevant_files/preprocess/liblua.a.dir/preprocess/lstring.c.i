# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "<command-line>" 2
# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
# 10 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lprefix.h" 1
# 11 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 2
...
# 14 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 2
...
# 16 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 2
...
# 18 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 2
...
# 19 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 2
...
# 23 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 2
# 44 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
int luaS_eqlngstr (TString *a, TString *b) {
  size_t len = a->u.lnglen;
  ((void)0);
  return (a == b) ||
    ((len == b->u.lnglen) &&
     (memcmp((((char *)(((a)))) + sizeof(TString)), (((char *)(((b)))) + sizeof(TString)), len) == 0));
}
...
unsigned int luaS_hashlongstr (TString *ts) {
  ((void)0);
  if (ts->extra == 0) {
    ts->hash = luaS_hash((((char *)(((ts)))) + sizeof(TString)), ts->u.lnglen, ts->hash);
    ts->extra = 1;
  }
  return ts->hash;
}
...
static void tablerehash (TString **vect, int osize, int nsize) {
  ...
  for (i = osize; i < nsize; i++)
    vect[i] = 
# 75 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
             ((void *)0)
# 75 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
                 ;
  for (i = 0; i < osize; i++) {
    TString *p = vect[i];
    vect[i] = 
# 78 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
             ((void *)0)
# 78 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
                 ;
    while (p) {
...
# 102 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
     ((void *)0)
# 102 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
     ) != 0), 0))) {
    if (nsize < osize)
...
static TString *createstrobj (lua_State *L, size_t l, int tag, unsigned int h) {
  ...
  ts->hash = h;
  ts->extra = 0;
  (((char *)(((ts)))) + sizeof(TString))[l] = '\0';
  return ts;
}


TString *luaS_createlngstrobj (lua_State *L, size_t l) {
  TString *ts = createstrobj(L, l, (4 | (2 << 4)), (L->l_G)->seed);
  ts->u.lnglen = l;
  return ts;
}
...
static void growstrtab (lua_State *L, stringtable *tb) {
  ...
  if (tb->size <= ((int)((((((size_t)((0x7fffffff))) <= ((size_t)(~(size_t)0))/sizeof(TString*)) ? (0x7fffffff) : ((unsigned int)(((((size_t)(~(size_t)0))/sizeof(TString*))))))))) / 2)
...
static TString *internshrstr (lua_State *L, const char *str, size_t l) {
  ...
  ((void)0);
  for (ts = *list; ts != 
# 205 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
                        ((void *)0)
# 205 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
                            ; ts = ts->u.hnext) {
    if (l == ts->shrlen && (memcmp(str, (((char *)(((ts)))) + sizeof(TString)), l * sizeof(char)) == 0)) {
...
TString *luaS_newlstr (lua_State *L, const char *str, size_t l) {
  if (l <= 40)
    ...
    TString *ts;
    if ((__builtin_expect(((l >= ((sizeof(size_t) < sizeof(lua_Integer) ? ((size_t)(~(size_t)0)) : (size_t)(0x7fffffffffffffffLL)) - sizeof(TString))/sizeof(char)) != 0), 0)))
      luaM_toobig(L);
...
# 251 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
TString *luaS_new (lua_State *L, const char *str) {
  unsigned int i = ((unsigned int)((size_t)(str) & 
# 252 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
                  (0x7fffffff * 2U + 1U)
# 252 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
                  )) % 53;
  int j;
  TString **p = (L->l_G)->strcache[i];
  for (j = 0; j < 2; j++) {
    if (strcmp(str, (((char *)(((p[j])))) + sizeof(TString))) == 0)
      return p[j];
  }
...
Udata *luaS_newudata (lua_State *L, size_t s, int nuvalue) {
  ...
  int i;
  GCObject *o;
  if ((__builtin_expect(((s > (sizeof(size_t) < sizeof(lua_Integer) ? ((size_t)(~(size_t)0)) : (size_t)(0x7fffffffffffffffLL)) - ((nuvalue) == 0 ? 
# 272 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
     __builtin_offsetof (
# 272 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
     Udata0
# 272 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
     , 
# 272 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
...
# 272 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
    ...
    luaM_toobig(L);
  o = luaC_newobj(L, 7, (((nuvalue) == 0 ? 
# 274 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
                                   __builtin_offsetof (
# 274 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
                                   Udata0
# 274 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
                                   , 
# 274 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
...
# 274 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
  ...
  u->nuvalue = nuvalue;
  u->metatable = 
# 278 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c" 3 4
                ((void *)0)
# 278 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lstring.c"
                    ;
  for (i = 0; i < nuvalue; i++)
    ((&u->uv[i].uv)->tt_=(0));
  return u;
