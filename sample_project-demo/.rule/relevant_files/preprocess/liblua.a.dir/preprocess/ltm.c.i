# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "<command-line>" 2
# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c"
# 10 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c"
# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lprefix.h" 1
# 11 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 14 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 16 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 18 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 19 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 20 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 23 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 24 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
# 26 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 2
...
const TValue *luaT_gettm (Table *events, TMS event, TString *ename) {
  ...
  if ((((((((tm))->tt_)) & 0x0F)) == (0))) {
    ...
    return 
# 65 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 3 4
          ((void *)0)
# 65 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c"
              ;
  }
  else return tm;
}
...
const char *luaT_objtypename (lua_State *L, const TValue *o) {
  Table *mt;
  if ((((((o))->tt_) == (((5) | (1 << 6)))) && (mt = ((&((((union GCUnion *)((((o)->value_).gc))))->h)))->metatable) != 
# 93 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 3 4
                                                     ((void *)0)
# 93 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c"
                                                         ) ||
      ((((((((o))->tt_)) & 0x0F)) == (7)) && (mt = ((&((((union GCUnion *)((((o)->value_).gc))))->u)))->metatable) != 
# 94 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c" 3 4
                                                            ((void *)0)
# 94 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c"
                                                                )) {
    const TValue *name = luaH_getshortstr(mt, luaS_new(L, "__name"));
    if ((((((((name))->tt_)) & 0x0F)) == (4)))
      return (((char *)(((((&((((union GCUnion *)((((name)->value_).gc))))->ts))))))) + sizeof(TString));
  }
...
void luaT_trybiniTM (lua_State *L, const TValue *p1, lua_Integer i2,
                                   int flip, StkId res, TMS event) {
  TValue aux;
  { TValue *io=(&aux); ((io)->value_).i=(i2); ((io)->tt_=((3 | (2 << 4)))); };
...
int luaT_callorderTM (lua_State *L, const TValue *p1, const TValue *p2,
  ...
  if (callbinTM(L, p1, p2, L->top, event))
    return !(((((((((&(L->top)->val)))->tt_)) & 0x0F)) == (0)) || ((((((&(L->top)->val)))->tt_) == (1)) && ((((&(L->top)->val))->value_).b) == 0));
# 206 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/ltm.c"
...
int luaT_callorderiTM (lua_State *L, const TValue *p1, int v2,
  ...
  if (isfloat) {
    ...
    { TValue *io=(&aux); ((io)->value_).i=(v2); ((io)->tt_=((3 | (2 << 4)))); };
  if (flip) {
    p2 = p1; p1 = &aux;
  }
  else
...
void luaT_adjustvarargs (lua_State *L, int nfixparams, CallInfo *ci,
  ...
  if (L->stack_last - L->top <= ((p->maxstacksize + 1))) { (void)0; luaD_growstack(L, (p->maxstacksize + 1), 1); { if ((L->l_G)->GCdebt > 0) { (void)0; luaC_step(L); (void)0;}; ((void)0); }; } else { ((void)0); };
