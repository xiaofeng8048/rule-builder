# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "<command-line>" 2
# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
# 10 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
# 1 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lprefix.h" 1
# 11 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
# 14 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
# 15 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
# 17 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
# 19 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
# 20 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
__attribute__((visibility("internal"))) extern const char *luaF_getlocalname (const Proto *func, int local_number,
                                         int pc);
# 21 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
# 24 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
...
__attribute__((visibility("internal"))) extern int luaU_dump (lua_State* L, const Proto* f, lua_Writer w,
                         void* data, int strip);
# 25 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 2
# 33 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
typedef struct {
  lua_State *L;
  ZIO *Z;
  const char *name;
...
# 52 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
...
static TString *LoadStringN (LoadState *S) {
  ...
  if (size == 0)
    return 
# 113 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 3 4
          ((void *)0)
# 113 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
              ;
  else if (--size <= 40) {
    char buff[40];
    ...
    LoadBlock(S,(((char *)(((ts)))) + sizeof(TString)),(size)*sizeof(((((char *)(((ts)))) + sizeof(TString)))[0]));
    return ts;
  }
}
...
static TString *LoadString (LoadState *S) {
  ...
  if (st == 
# 132 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 3 4
           ((void *)0)
# 132 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
               )
  ...
  for (i = 0; i < n; i++) {
    ...
    switch (t) {
      case 0:
        ...
        break;
      case 1:
        { TValue *io=(o); ((io)->value_).b=(LoadByte(S)); ((io)->tt_=(1)); };
        break;
      case (3 | (1 << 4)):
        { TValue *io=(o); ((io)->value_).n=(LoadNumber(S)); ((io)->tt_=((3 | (1 << 4)))); };
        break;
      case (3 | (2 << 4)):
        { TValue *io=(o); ((io)->value_).i=(LoadInteger(S)); ((io)->tt_=((3 | (2 << 4)))); };
        break;
      case (4 | (1 << 4)):
      case (4 | (2 << 4)):
        { TValue *io = (o); TString *x_ = (LoadString(S)); ((io)->value_).gc = (&(((union GCUnion *)((x_)))->gc)); ((io)->tt_=(((x_->tt) | (1 << 6)))); ((void)S->L, ((void)0)); };
        break;
      default: ((void)0);
    }
  }
...
static void LoadProtos (LoadState *S, Proto *f) {
  ...
  for (i = 0; i < n; i++)
    f->p[i] = 
# 188 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 3 4
             ((void *)0)
# 188 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
                 ;
  for (i = 0; i < n; i++) {
...
static void LoadUpvalues (LoadState *S, Proto *f) {
  ...
  for (i = 0; i < n; i++) {
    f->upvalues[i].name = 
# 202 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 3 4
                         ((void *)0)
# 202 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
                             ;
...
static void LoadDebug (LoadState *S, Proto *f) {
  ...
  for (i = 0; i < n; i++)
    f->locvars[i].varname = 
# 227 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 3 4
                           ((void *)0)
# 227 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
                               ;
  for (i = 0; i < n; i++) {
...
static void LoadFunction (LoadState *S, Proto *f, TString *psource) {
  ...
  if (f->source == 
# 241 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 3 4
                  ((void *)0)
# 241 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
                      )
    f->source = psource;
...
LClosure *luaU_undump(lua_State *L, ZIO *Z, const char *name) {
  ...
  { TValue *io = ((&(L->top)->val)); LClosure *x_ = (cl); ((io)->value_).gc = (&(((union GCUnion *)((x_)))->gc)); ((io)->tt_=((((6 | (1 << 4))) | (1 << 6)))); ((void)L, ((void)0)); };
  luaD_inctop(L);
  cl->p = luaF_newproto(L);
  LoadFunction(&S, cl->p, 
# 310 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c" 3 4
                         ((void *)0)
# 310 "/home/zhj/qa-regression/container_test/projects/c/cases/lua/lundump.c"
                             );
  ((void)0);
  ;
  return cl;
